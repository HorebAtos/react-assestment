import { CompaniesTable, EmployeesTable } from "./interfaces";

export const getUsers = (): Promise<EmployeesTable> => new Promise((resolve, reject) => {
    setTimeout(() => {
        resolve([
...
export const getCompanies = (): Promise<CompaniesTable> => new Promise((resolve, reject) => {
    setTimeout(() => {
        resolve([
